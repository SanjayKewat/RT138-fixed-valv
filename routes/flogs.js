...
//    var tm=req.param('to');
    ...
    var strQuery1 ="call fun_log_yr_open("+rigid+","+year+")"; //" SELECT * FROM fun_log_year_open WHERE rig_id='"+rigid+"' AND yr ='"+year+"'";
    var strQuery2 = "call fun_log_yr_close("+rigid+","+year+")"; //" SELECT * FROM fun_log_year_close WHERE rig_id='"+rigid+"' AND yr ='"+year+"'";
    var strQuery3 = "call fun_log_month_open("+rigid+","+year+")";  //" SELECT * FROM fun_log_mnth_open WHERE rig_id='"+rigid+"' AND yr ='"+year+"'";
    var strQuery4 = "call fun_log_month_close("+rigid+","+year+")";//" SELECT * FROM fun_log_mnth_close WHERE rig_id='"+rigid+"' AND yr ='"+year+"'";
