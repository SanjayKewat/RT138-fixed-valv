...
//Here to read data for Column Monthwise Function  logs page
/*exports.mwise_flog_clm = function(req, res,next){
 ...
 switch (vid) {
     ...
     case 1:
     open_col_name="an_open_total";
     close_col_name="an_close_total";
     break;

     case 2:
     open_col_name="up_open_total";
     close_col_name="up_close_total";
     break;

     case 3:
     open_col_name="bl_open_total";
     close_col_name="bl_close_total";
     break;

     case 4:
     open_col_name="lo_open_total";
     close_col_name="lo_close_total";
     break;

     case 5:
     open_col_name="ch_open_total";
     close_col_name="ch_close_total";
     break;

     case 6:
     open_col_name="ki_open_total";
     close_col_name="ki_close_total";
     break;

     case 7:
     open_col_name="by_low_total";
     close_col_name="by_high_total";
     break;
 }
...
exports.mwise_flog_clm = function(req, res,next){
    ...
    var opnQuery = "select * from f_month_colmn_log_view where  Rig_ID="+rigid+" and valve_id="+open_col_name+" and com_month="+month+" and com_year="+year;
    var clsQuery = "select * from f_month_colmn_log_view where Rig_ID="+rigid+" and valve_id="+close_col_name+" and com_month="+month+" and com_year="+year;
    ...
    mysqlPool.getConnection(function(err, connection) {
        ...
        if (err) {
            ...
            res.statusCode = 503;
            res.json({
                result: 'Monthwise Function Log Column page error',
                err:    err.code
            });
        } else
        {
            connection.query(opnQuery, function (err, rows) {
                if (err) {
                    ...
                    res.statusCode = 500;
                    res.json({
                        result: 'Monthwise Function Log page error',
                        err: err.code
                    });
                }
                try {
...
//Here to read data for Scatter Monthwise Function  logs page
exports.mwise_flog_sct = function(req, res,next){
    ...
    var opnQuery = "select * from function_tab where Value=1 and Rig_ID="+rigid+" and Valve_ID="+open_col_name+" and month(Date_time)="+month+" and year(Date_time)="+year;
    var clsQuery = "select * from function_tab where Value=1 and Rig_ID="+rigid+" and Valve_ID="+close_col_name+" and month(Date_time)="+month+" and year(Date_time)="+year;
